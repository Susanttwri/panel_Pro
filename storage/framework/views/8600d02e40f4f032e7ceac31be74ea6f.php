...
<body>
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="<?php echo e(route('admin.products.index')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.products.index') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('products')); ?>" target="_blank" class="nav-item">
    ...
    <div class="main-content">
        <header class="topbar">
            ...
            <div class="topbar-actions">
                <a href="<?php echo e(route('home')); ?>" target="_blank" class="view-site-link"><i class="fas fa-external-link-alt"></i> View Site</a>
                <div class="topbar-user">
                    <div class="avatar"><?php echo e(substr(Auth::user()->name, 0, 1)); ?></div>
                    <div class="info"><strong><?php echo e(Auth::user()->name); ?></strong><br><span>Administrator</span></div>
                </div>
            </div>
        </header>
        <div class="content">
            ...
            <?php endif; ?>
            <?php if($errors->any()): ?>
                <div class="alert alert-error"><i class="fas fa-exclamation-circle"></i><div><?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><div><?php echo e($error); ?></div><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></div></div>
            <?php endif; ?>
...
<?php /**PATH C:\Users\Lenovo\Downloads\panel_pro\resources\views/layouts/admin.blade.php ENDPATH**/ ?>