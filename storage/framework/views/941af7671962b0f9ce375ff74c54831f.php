...
<head>
    ...
    <meta name="description" content="<?php echo $__env->yieldContent('meta_description', 'Discover premium products at PanelsPro.'); ?>">
    <title><?php echo $__env->yieldContent('title', 'PanelsPro'); ?></title>
...
<body>
    <nav class="navbar">
        ...
        <div class="navbar-links">
            ...
            <a href="<?php echo e(route('products')); ?>" class="<?php echo e(request()->routeIs('products') ? 'active' : ''); ?>">Products</a>
            <?php if(auth()->guard()->check()): ?>
                <a href="<?php echo e(route('admin.products.index')); ?>" class="admin-link"><i class="fas fa-lock"></i> Admin</a>
            <?php else: ?>
                <a href="<?php echo e(route('admin.login')); ?>" class="admin-link"><i class="fas fa-lock"></i> Admin</a>
            <?php endif; ?>
        </div>
    </nav>
...
<?php /**PATH C:\Users\Lenovo\Downloads\panel_pro\resources\views/layouts/frontend.blade.php ENDPATH**/ ?>